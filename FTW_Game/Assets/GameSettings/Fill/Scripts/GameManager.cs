...
namespace FTW.Game.Fill
{
    public class GameManager : BaseGame
    {
        ...
        private void StartGame()
        {
            ...
            cells = new Cell[level.Row, level.Col];
        ...
        private void SpawnLevel()
        {
            ...
            Camera.main.orthographicSize = Mathf.Max(level.Row, level.Col) + 2f;
            ...
            for (int i = 0; i < level.Row; i++)
            {
                for (int j = 0; j < level.Col; j++)
                {
                    ...
                    cells[i, j].Init(level.Data[(i * level.Col) + j]);
        ...
        private void Update()
        {
            ...
            else if (Input.GetMouseButton(0))
            {
                ...
                if (AddEmpty())
                {
                    ...
                    Transform edge = Instantiate(edgePrefab);
        ...
        private bool AddEmpty()
        {
            ...
            if (cells[startPos.x, startPos.y].Filled)
            {
                return false;
            }

            if (cells[endPos.x, endPos.y].Filled)
            {
                return false;
            }
        ...
        private bool AddToEnd()
        {
            ...
            if (cells[startPos.x, startPos.y] != lastCell)
            {
                return false;
            }
        ...
        private bool RemoveFromEnd()
        {
            ...
            if (cells[endPos.x, endPos.y] != lastCell)
            {
                return false;
            }
